...
cmd.plot(cmap='GnBu')
plt.savefig('6-cm-MinPoint.pdf', format='pdf')
...
colours = {0: '#ff33a8', 1: '#a8ff33', 2: '#31a1f4', 3: '#e98f5a', -1: '#808080'}
...
plt.xlabel('x')
plt.ylabel('y')
plt.title('Different MinPoint case')
plt.savefig('6-MinPoint.pdf', format='pdf')
plt.show()